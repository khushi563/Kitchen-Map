...
async function fetchRecipes(query) {
    ...
    try {
        ...
        recipeList.innerHTML = "<p style='text-align:center;'>Error loading recipes ⚠️</p>";
    }
    loading.textContent = "";
}
...
function showRecipeDetails(recipe) {
    ...
    modalBody.innerHTML = `
        ...
        ${recipe.strYoutube ? `<p><a href="${recipe.strYoutube}" target="_blank">▶ Watch on YouTube</a></p>` : ""}
      `;
...
function displayFavorites() {
    ...
    if (favorites.length === 0) {
        favoriteList.innerHTML = "<p style='text-align:center;'>No favorite recipes yet ❤️</p>";
        return;
    }
...
// Initial load (default search: chicken)
